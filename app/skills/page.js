  ...
  return (
    <div className="flex flex-col justify-center items-center relative z-1">
      <div className="flex flex-col justify-between items-center w-full max-w-[1100px] gap-3">
        <h2 className="text-4xl text-center font-semibold mt-5 text-[#F2F3F4]">Skills</h2>
        <p className="text-lg text-center max-w-[600px] text-[#b1b2b3]">Here are some of the skills I have acquired over the years.</p>
